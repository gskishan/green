frappe.listview_settings["Task"] = {
    ...
    onload: function (listview) {
        console.log("Onload function executed");  // Debugging: check if onload runs

        // Add button for exporting the Gantt chart as a PDF
        listview.page.add_inner_button(__("In PDF"), () => {
